                                    ...
                                    EosWrapper_t<device_t> const & eos)
{
  ...
  // Left variables
  //
  const auto rl = fmax(qleft[Hydro::IAD0] + qleft[Hydro::IAD1], smallr);
  auto       pl = fmax(qleft[Hydro::IP], rl * smallp);
  const auto ul = qleft[Hydro::IU];

  const auto eintl = eos.mixture_specific_eint(
    rl, pl, qleft[Hydro::IA0], 1 - qleft[Hydro::IA0], qleft[Hydro::IAD0], qleft[Hydro::IAD1]);
  pl = eos.mixture_pressure(
    rl, eintl, qleft[Hydro::IA0], 1 - qleft[Hydro::IA0], qleft[Hydro::IAD0], qleft[Hydro::IAD1]);
  ...
  // Right variables
  //
  const auto rr = fmax(qright[Hydro::IAD0] + qright[Hydro::IAD1], smallr);
  auto       pr = fmax(qright[Hydro::IP], rr * smallp);
  const auto ur = qright[Hydro::IU];

  const auto eintr = eos.mixture_specific_eint(
    rr, pr, qright[Hydro::IA0], 1 - qright[Hydro::IA0], qright[Hydro::IAD0], qright[Hydro::IAD1]);
  ...
  if (SL > ZERO_F)
  {
    ro_0 = qleft[Hydro::IAD0];
    ro_1 = qleft[Hydro::IAD1];
    ro = rl;
    uo = ul;
    // vo = vl;
    ptoto = ptotl;
  ...
  {
    ro_0 = qleft[Hydro::IAD0] * factorL;
    ro_1 = qleft[Hydro::IAD1] * factorL;
    ro = rl * factorL;
    uo = ustar;
    // vo = vl * factorL;
    ptoto = ptotstar;
  ...
  {
    ro_0 = qright[Hydro::IAD0] * factorR;
    ro_1 = qright[Hydro::IAD1] * factorR;
    ro = rr * factorR;
    uo = ustar;
    // vo = vr * factorR;
    ptoto = ptotstar;
  ...
  {
    ro_0 = qright[Hydro::IAD0];
    ro_1 = qright[Hydro::IAD1];
    ro = rr;
    uo = ur;
    // vo = vr;
    ptoto = ptotr;
  ...
  flux[Hydro::IAD0] = ro_0 * uo;
  flux[Hydro::IAD1] = ro_1 * uo;
                                            ...
                                            EosWrapper_t<device_t> const & eos)
{
  ...
  // Left variables
  //
  const auto rL = fmax(qL[Hydro::IAD0] + qL[Hydro::IAD1], smallr);
  auto       pL = fmax(qL[Hydro::IP], rL * smallp);
  const auto uL = qL[Hydro::IU];

  const auto eintL = eos.mixture_specific_eint(
    rL, pL, qL[Hydro::IA0], 1 - qL[Hydro::IA0], qL[Hydro::IAD0], qL[Hydro::IAD1]);
  pL = eos.mixture_pressure(
    rL, eintL, qL[Hydro::IA0], 1 - qL[Hydro::IA0], qL[Hydro::IAD0], qL[Hydro::IAD1]);
  ...
  // Right variables
  //
  const auto rR = fmax(qR[Hydro::IAD0] + qR[Hydro::IAD1], smallr);
  auto       pR = fmax(qR[Hydro::IP], rR * smallp);
  const auto uR = qR[Hydro::IU];

  const auto eintR = eos.mixture_specific_eint(
    rR, pR, qR[Hydro::IA0], 1 - qR[Hydro::IA0], qR[Hydro::IAD0], qR[Hydro::IAD1]);
  pR = eos.mixture_pressure(
    rR, eintR, qR[Hydro::IA0], 1 - qR[Hydro::IA0], qR[Hydro::IAD0], qR[Hydro::IAD1]);
  ...
  UstarL[Hydro::IAD0] = factorL * qL[Hydro::IAD0];
  UstarL[Hydro::IAD1] = factorL * qL[Hydro::IAD1];
  ...
  UstarR[Hydro::IAD0] = factorR * qR[Hydro::IAD0];
  UstarR[Hydro::IAD1] = factorR * qR[Hydro::IAD1];
  ...
  fL[Hydro::IAD0] = qL[Hydro::IAD0] * uL;
  fL[Hydro::IAD1] = qL[Hydro::IAD1] * uL;
  fL[Hydro::ID] = fL[Hydro::IAD0] + fL[Hydro::IAD1];
  ...
  fR[Hydro::IAD0] = qR[Hydro::IAD0] * uR;
  fR[Hydro::IAD1] = qR[Hydro::IAD1] * uR;
  fR[Hydro::ID] = fR[Hydro::IAD0] + fR[Hydro::IAD1];
  ...
  // Compute the Godunov flux
  flux[Hydro::IAD0] = aL * (fL[Hydro::IAD0] + Sm * (UstarL[Hydro::IAD0] - qL[Hydro::IAD0])) +
                      aR * (fR[Hydro::IAD0] + Sp * (UstarR[Hydro::IAD0] - qR[Hydro::IAD0]));
  flux[Hydro::IAD1] = aL * (fL[Hydro::IAD1] + Sm * (UstarL[Hydro::IAD1] - qL[Hydro::IAD1])) +
                      aR * (fR[Hydro::IAD1] + Sp * (UstarR[Hydro::IAD1] - qR[Hydro::IAD1]));
  flux[Hydro::ID] = flux[Hydro::IAD0] + flux[Hydro::IAD1];
