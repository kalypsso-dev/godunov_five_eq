 ...
 */
#ifndef KALYPSSO_GODUNOV_FIVE_EQ_CONVERTTOPRIMITIVESVARIABLES_H_
#define KALYPSSO_GODUNOV_FIVE_EQ_CONVERTTOPRIMITIVESVARIABLES_H_
...
#include <godunov_five_eq/models/utils.h> // for computePrimitives
...
public:
   ...
   *
   */
  ConvertToPrimitivesVariablesFunctor(StencilHelper_t              stencil_helper,
  ...
  extrapol_2d(CellLocation<dim> const &       cell_loc_neigh,
  ...
  KOKKOS_INLINE_FUNCTION real_t
  extrapol_3d(CellLocation<dim> const &       cell_loc_neigh,
              CellLocation<dim> const &       cell_loc_left_x,
              CellLocation<dim> const &       cell_loc_right_x,
              CellLocation<dim> const &       cell_loc_left_y,
              CellLocation<dim> const &       cell_loc_right_y,
  ...
  // ==============================================================
  KOKKOS_INLINE_FUNCTION real_t
  interpol_order2(CellLocation<dim> const &       cell_loc_neigh,
                  Kokkos::Array<int, dim> const & ixyz,
                  int32_t const                   ivar) const;
  ...
  // ==============================================================
  KOKKOS_INLINE_FUNCTION real_t
  interpol_order4(CellLocation<dim> const &       cell_loc_neigh,
                  Kokkos::Array<int, dim> const & ixyz,
                  int32_t const                   ivar) const;
   ...
   * \param[in] cellindex_out cell index (ghost cell) where to write data to
   ...
   */
  KOKKOS_INLINE_FUNCTION void
  conservative_interpolation_order2(CellLocation<dim> const & cell_loc_neigh,
   ...
   */
  KOKKOS_INLINE_FUNCTION void
  conservative_interpolation_order4(CellLocation<dim> const & cell_loc_neigh,
                                    coord_t<dim> const &      coord_out,
                                    index_t const &           cellindex_out,
                                    iOct_t const &            iOct_global,
                                    iOct_t const &            iOct_out) const;
...
#endif // KALYPSSO_GODUNOV_FIVE_EQ_CONVERTTOPRIMITIVESVARIABLES_H_
