...
ReadFluxesAndConservativeUpdateFunctor<dim, device_t>::ReadFluxesAndConservativeUpdateFunctor(
  ...
  , m_eos(eos)
  , m_vol_frac_adv_source_term_type(
      core::get_volume_fraction_advection_source_term_type(config_map))
  , m_dt(dt)
  ...
  real_t                             dt)
{
  ...
  // launch computation
  Kokkos::parallel_for("kalypsso::godunov_five_eq::ReadFluxesAndConservativeUpdateFunctor",
